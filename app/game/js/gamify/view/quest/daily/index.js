...
class Daily extends Component {
  ...
  questData = [
    {route : 'BlankPage', name : 'Item Tugas Harian', title : 'Item Tugas Harian'},
    {route : 'BlankPage', name : 'Item Tugas Harian', title : 'Item Tugas Harian'},
    {route : 'BlankPage', name : 'Item Tugas Harian', title : 'Item Tugas Harian'}
  ]
    ...
    return (
      <Container style={styles.container}>
        <Header>
          ...
          <Body>
            {/* TODO : nantinya akan query ke server */}
            <Title>{name ? this.props.name : "Tugas Harian"}</Title>
          </Body>
...
export default connect(mapStateToProps, bindAction)(Daily);
