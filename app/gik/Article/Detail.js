...
//import WebViewAutoHeight from '../../comp/WebViewAutoHeight';
				...
				this.setState({
					videoComp:
						<TouchableHighlight
							...
							onPress={()=>Actions.GIKVideoDetail({video:this.state.data.video})}
						>
							<Image
								style={{
									height:this.state.dimensions.width/5.5,
		...
		if(this.state.ready){
			return(
				<View style={{flex:1,paddingBottom:35}}>
					<ScrollView automaticallyAdjustContentInsets={false} style={{backgroundColor:'#000'}} refreshControl={this._refreshControl()} ref='ScrollView'>
